...
namespace FWT.TL.Core.Extensions
{
    ...
    public static class QueryableExtensions
    {
        ...
        public static IQueryable<TSource> OrderByIndex<TSource, TKey>(this IQueryable<TSource> source, int column, OrderBy direction = FWT.TL.Core.Data.OrderBy.Ascending, params OrderableColumn<TSource, TKey>[] @params)
        {
        ...
        public static IOrderedQueryable<TSource> OrderWithDirection<TSource, TKey>(this IQueryable<TSource> source, Expression<Func<TSource, TKey>> keySelector, OrderBy direction = FWT.TL.Core.Data.OrderBy.Ascending)
        {
